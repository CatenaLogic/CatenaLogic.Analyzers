CatenaLogic.Analyzers
=====================

Name|Badge
---|---
Downloads|![NuGet downloads](https://img.shields.io/nuget/dt/catenalogic.analyzers.svg)
NuGet stable version|![Version](https://img.shields.io/nuget/v/catenalogic.analyzers.svg)
NuGet unstable version|![Pre-release version](https://img.shields.io/nuget/vpre/catenalogic.analyzers.svg)
...
This project provides Roslyn code analyzers to provide info on best practices.

* CL0001 => Use async overloads inside async methods
