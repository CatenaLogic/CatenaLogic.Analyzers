namespace CatenaLogic.Analyzers
{
    ...
    internal class CL0008Diagnostic : DiagnosticBase
    {
        public const string Id = "CL0008";
        ...
        private void HandleSyntaxNode(InvocationExpressionSyntax syntaxNode, SyntaxNodeAnalysisContext context, CancellationToken cancellationToken)
        {
            ...
            context.ReportDiagnostic(Diagnostic.Create(Descriptors.CL0008_DoUseThrowIfNullForArgumentCheck, syntaxNode.GetLocation(), "zz"));
        }
    }
}
